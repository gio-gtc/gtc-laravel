...
export default function Orders() {
    ...
    const catalog = useMemo(
        (): OrdersCatalogValue => ({
            ...
            _legacy_orders: props._legacy_orders ?? [],
            venue_items: venueItems,
            venue_item_assigned: props.venue_item_assigned,
            venue_item_notes: props.venue_item_notes,
        ...
        [
            ...
            props.venues,
            props.orders,
            props.grouped_orders,
            props.order_status_options,
            props._legacy_orders,
            venueItems,
            props.venue_item_assigned,
            props.venue_item_notes,
