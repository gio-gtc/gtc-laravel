...
function Sidebar({
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                ...
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="mt-[51px] w-(--sidebar-width) border-r border-[#5b5b5c] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
                    style={
                        {
    ...
    return (
        <div
            className="group peer relative text-sidebar-foreground md:block"
            data-state={state}
        ...
        >
            <div
                className={cn(
                    'sticky inset-y-0 top-[0px] z-10 h-screen w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
                    side === 'left'
