...
function Sidebar({
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                ...
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="mt-[50px] w-(--sidebar-width) border-r border-[#5b5b5c] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
                    style={
                        {
    ...
    return (
        <div
            ...
            data-slot="sidebar"
        >
            {/* Reserves horizontal space in the flex row so main content does not sit under the fixed sidebar */}
            <div
                className={cn(
