...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-md text-xs font-semibold transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                default:
                    'bg-brand-gtc-red text-primary-foreground shadow-xs hover:bg-brand-gtc-red/70',
                destructive:
                    'bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
                outline:
                    'border border-gray-300 text-gray-700 bg-background shadow-xs hover:bg-accent',
                secondary:
            ...
            size: {
                ...
                sm: 'h-[30px] rounded-md px-[12px] has-[>svg]:px-2.5',
                // md: 'h-6.5 rounded-md px-3 has-[>svg]:px-2.5 text-sm',
                md: 'h-[40px] rounded-md px-3 has-[>svg]:px-2.5 text-sm',
