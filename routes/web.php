...
use App\Http\Controllers\Api\OrderItemBulkUpdateController;
use App\Http\Controllers\Api\OrderItemDeleteController;
use App\Http\Controllers\Api\OrderItemReviseController;
...
Route::middleware([BffAuth::class])->group(function () {
    ...
    Route::prefix('api')->group(function () {
        ...
        Route::post('order-items/bulk-update', OrderItemBulkUpdateController::class)->name('api.order-items.bulk-update');
        Route::patch('order-items/{orderItem}', OrderItemUpdateController::class)->name('api.order-items.update');
        Route::post('order-items/{orderItem}/revise', OrderItemReviseController::class)->name('api.order-items.revise');
